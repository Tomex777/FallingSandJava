...
- Follow-up fix pass: initialize stage viewports before frame one; add outside-tap dismissal for the creator menu; position the mobile Tools menu from its stage viewport for a stable top-right anchor; correct workflow taps to select SPAWN and exercise dismissal. Build and emulator retest pending.
